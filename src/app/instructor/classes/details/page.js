...
import Navigation, {
  NAV_LINKS,
} from "../../../../components/instructor/Navigation";
  ...
  const SelectModel = () => {
    return (
      <FormControl sx={{ width: "100%" }}>
        ...
        <FormHelperText>Select perferred language model</FormHelperText>
      </FormControl>
    );
  };
  return (
          ...
          <Grid m={2} container direction={"column"} spacing={2}>
            ...
            <Grid>
              <FormControl sx={{ width: "100%" }}>
                ...
                <FormHelperText>Could place the schedule here</FormHelperText>
              </FormControl>
            </Grid>
            <Grid>
              <SelectModel />
            ...
            <Grid>
              <FormControl sx={{ width: "100%" }}>
                <FormLabel>Students that currently have access (30)</FormLabel>
                <StudentList />
              </FormControl>
            </Grid>
          </Grid>
